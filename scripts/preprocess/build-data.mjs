...
import { _medOf, coefficientOfVariation, collectPaymentDates, driftVsBaseline, momentumDelta, monthlyDsoSeries, paymentIntervals, theilSenSlope } from './payment-behavior.mjs'
import { impactBedragScore, potentieelScoreFor, urgentieScore } from './scoring.mjs'
import { daysBetween, formatEUR, median, num, oneDay, percentile, quartile, round } from './utils.mjs'

export function buildGeneratedData({ repoRoot }) {
  const REPO = repoRoot
